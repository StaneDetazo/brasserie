                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="/admin/addProduct">Ajouter un article</a></li>
                            </ul>
                        </li>
                    </ul>
                    <form  action="commandes" class="d-flex">
        ...
        <header class="bg-img bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="bg-img text-center text-white">
                    <h1 class="display-4 fw-bolder">GERER VOS COMMANDES ET STOCK</h1>
